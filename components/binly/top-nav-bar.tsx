...
import { Search, Sparkles, Bell, Settings, LogOut, ChevronDown } from 'lucide-react';
...
export function TopNavBar({ onOpenAIAssistant }: TopNavBarProps) {
  ...
  return (
    <div className="h-16 bg-white flex items-center justify-between px-6 shrink-0 border-b border-gray-200 shadow-sm">
      {/* Left side - Search */}
