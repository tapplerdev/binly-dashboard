...
import { X, MapPin, Calendar, Loader2, Navigation, Building2, FileText, AlertCircle } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full flex flex-col overflow-hidden pointer-events-auto">
            ...
            <div className="flex-1 relative bg-gray-100">
              ...
              <APIProvider apiKey={process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY || ''}>
                ...
                >
                  ...
                  {/* Destination — green draggable pin (relocation only) */}
                    ...
                    >
                      <div className="relative cursor-grab active:cursor-grabbing">
                        ...
                        <div className="absolute inset-0 -m-2">
                          <div className="w-12 h-12 rounded-full bg-green-500 opacity-25 animate-ping" />
                        </div>
                        <div className="relative w-10 h-10 rounded-full bg-green-600 flex items-center justify-center shadow-lg ring-2 ring-white">
                          <Navigation className="w-5 h-5 text-white" />
                        </div>
                        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs font-semibold text-green-700 bg-green-100 px-2 py-0.5 rounded shadow">
                          Destination
                        </div>
                      </div>
                    </AdvancedMarker>
              ...
              {isRelocation && (
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2 shadow text-xs text-gray-600 text-center pointer-events-none">
                  {reverseGeocoding
                    ...
                    : 'Drag the green pin to set destination · or type an address on the right'}
                </div>
              )}
          ...
          <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 shrink-0 flex items-center justify-between gap-4">
            <p className="text-xs text-gray-400">
              {isRelocation
                ? 'Drag the green pin on the map or type an address to set the destination'
